...
- **Duplicate-issue detection sync**: The duplicate-detection search pattern (`gh issue list --search "<keywords>" --state all --limit 5`) and keyword-extraction approach are duplicated between `commands/issue-create.md` (Step 4) and `commands/pr-review.md` (Step 8). Any change to the search command or keyword strategy must be applied to both locations.
